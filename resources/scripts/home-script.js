...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.onload = function () {
        ...
        var mlData = {
        labels: ["Scikit-learn", "PyTorch", "TensorFlow", "Trees (RandomForest, XGBoost)", "Deployment", "Serverless"],
        datasets: [{
        ...
        var nlpData = {
        labels: ["NLTK", "SpaCy", "Gensim", "Transformers", "Proompt Engineering/LLMs"],
        datasets: [{
            data: [95, 80, 55, 95, 95],
        ...
        var mlopsData = {
        labels: ["Docker & Kubernetes", "Gradio", "Weights & Biases", "Amazon SageMaker"],
        datasets: [{
            data: [95, 70, 50, 40],
